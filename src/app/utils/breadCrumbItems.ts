...
export const bItemDepartamentosList: MenuItem[] = [bItemHome, { routerLink: '/tf/areas', label: 'Áreas' }]
...
export const bItemVacantesDetail: MenuItem[] = [bItemHome, { routerLink: '/tf/reclutamiento/vacantes', label: 'Vacantes' }]